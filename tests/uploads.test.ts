import fs from 'fs';
import type { ResponseLike } from 'modern-relay/internal/to-file';
import { toFile } from 'modern-relay/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('modern-relay/core/uploads');
    await expect(
