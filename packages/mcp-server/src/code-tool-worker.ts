...
import { ModernRelay, ClientOptions } from 'modern-relay';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: ModernRelay)`
    : `const run: (${functionSource.client}: ModernRelay) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.branches.schema.retrieve',
    'client.branches.classes.create',
    'client.branches.classes.createBatch',
    'client.branches.classes.delete',
    'client.branches.classes.update',
    'client.branches.properties.create',
    'client.branches.properties.createBatch',
    'client.branches.properties.delete',
    'client.branches.properties.update',
    'client.branches.entities.create',
    'client.branches.entities.delete',
    'client.branches.entities.list',
    'client.branches.entities.listBackreferences',
    'client.branches.entities.query',
    'client.branches.entities.retrieve',
    'client.branches.entities.update',
    'client.branches.entities.updateBatch',
    'client.proposals.accept',
    'client.proposals.create',
    'client.proposals.delete',
