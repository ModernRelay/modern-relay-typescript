...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['MODERN_RELAY_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['MODERN_RELAY_LOG'] or 'warn' if it isn't set.
   */
...
export class ModernRelay {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? ModernRelay.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('MODERN_RELAY_LOG'), "process.env['MODERN_RELAY_LOG']", this) ??
      defaultLogLevel;
  ...
  static ModernRelay = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ModernRelayError = Errors.ModernRelayError;
